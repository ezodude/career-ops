...
| [CP-12](CP-12-region-gate-country-precision.md) | **Region-gate country precision** (location judged alone, strict UK+Europe+US allow-list, word-boundary matching) | 1 | CP-11 | M | ✅ Shipped |
